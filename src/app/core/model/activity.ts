...
import {ActivityDeployActor} from "./activity.deploy.actor";
...
export class Activity {
    ...
    actorId: string | ActivityDeployActor // "the id (long) of the actor that can execute this task, null otherwise",
    ...
    constructor(activityData: any)
    {
        ...
        if (this.actorId instanceof ActivityDeployActor) {
